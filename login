...
<head>
    ...
    <title>Log into your Nitro Type account</title>
    <meta name="description" content="Log into your Nitro Type and start racing!" />
    ...
    <script type="application/ld+json">
        ...
        <!-- Favicon -->
<link rel="apple-touch-icon" sizes="180x180" href="https://www.nitrotype.com/nitrotype-apple-touch-icon.png" />
<link rel="icon" type="image/png" sizes="32x32" href="https://www.nitrotype.com/favicon-32x32.png" />
<link rel="icon" type="image/png" sizes="16x16" href="https://www.nitrotype.com/favicon-16x16.png" />
<link rel="manifest" href="https://www.nitrotype.com/nitrotype.site.webmanifest" />
<link rel="mask-icon" href="https://www.nitrotype.com/safari-pinned-tab.svg" color="#ff3544" />
<meta name="msapplication-TileColor" content="#ff0000"/>
<meta name="theme-color" content="#303344/">
<!-- End Favicon -->
    <!-- Start: Open Graph Meta tags -->
<meta name="twitter:card" content="summary_large_image" />
<meta property="og:title" content="Log into your Nitro Type account"/>
...
<meta name="og:description" content="Log into your Nitro Type and start racing!" />
<!-- End Open Graph -->

<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@nitrotype">
<meta name="twitter:creator" content="@nitrotype">
<meta name="twitter:title" content="Log into your Nitro Type account">
<meta name="twitter:description" content="Log into your Nitro Type and start racing!">
<meta name="twitter:image" content="https://www.nitrotype.com/dist/site/images/social/nitrotype-teaser-lg.jpg">
    ...
    <link rel="stylesheet" type="text/css" href="https://www.nitrotype.com/dist/site/css/app.min.css?ff981dd1b3394669a3c28f8c0af00f40-1840"/>

    <script src="https://www.nitrotype.com/index/0bfc0350579b04b4e7aea752dddffb946a7ad950-1840/bootstrap.js"></script>
    <script>
        if(localStorage.getItem('rt_servers')){
            ...
            window.NTSERVERS = function(){
                return ["realtime1.nitrotype.com"];
            }
        }
    ...
    window.NTGLOBALS = (function () {
        ...
        var globals = {
            ...
            CACHE_ID: "0bfc0350579b04b4e7aea752dddffb946a7ad950",
            CACHE_ID_INTEGER: 1840,
...
<div id="root">
    <div style="position: absolute; top: 0; left: 0; width: 100vw; height: 100vh; background: #2E3141; padding: 20px; box-sizing: border-box;">
        <div style="box-shadow: 0 1px 10px rgba(2, 2, 2, 0.14); text-align: center; width: 280px; height: auto; min-height: 0 !important; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: #20222e; border-radius: 10px; padding: 40px 20px; box-sizing: border-box;">
            <div style="display: inline-block; height: 0;  padding: 0;  padding-bottom: 14%;  position: relative;  width: 100%;">
                        ...
                        <path
                            ...
                            fill="#fff"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M197.202 35.99c2.092-2.986 3.137-6.463 3.137-10.43 0-4.65-1.61-8.255-4.83-10.815-3.179-2.602-7.654-3.903-13.425-3.903h-19.375l-2.382 11.714 14.539-.049.004-.019h4.955c3.681 0 5.521 1.515 5.521 4.543 0 1.878-.565 3.35-1.694 4.416-1.129 1.024-2.718 1.536-4.768 1.536h-6.061l-14.607-.04-4.613 22.692h14.805l2.196-11.262h3.638l6.211 11.262h15.369l-7.339-13.054c3.764-1.45 6.67-3.647 8.719-6.59z" fill="#fff"/>
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M22.448 0H.392l16.61 27.836-7.839 40.067h64.74L88.043 0H22.447z" fill="#D62F3A"/>
        ...
        <script src="https://www.nitrotype.com/dist/site/js/ab~ac~au~co~cs~cu~ev~in~le~lm~lt~ne~rm~se~si~st~su~tc~ud~wo.js?612c95981b82dc94467f530b20ee1dc3-1840"></script>
                    <script src="https://www.nitrotype.com/dist/site/js/vendors~ab~ac~au~co~cs~cu~ev~fr~ga~in~le~lm~lt~ne~ot~pg~ra~rm~se~sh~si~sr~st~su~tc~te~ud~wo.js?dc6633b9b6bc2d6a35a1fed3db682760-1840"></script>
                    <script src="https://www.nitrotype.com/dist/site/js/au.js?887a12341660110190a174e9a43883a8-1840"></script>
            
    <script>
            if(__getSession('membership') !== 'gold') {
                (function() {
                    !function(e){var s=new XMLHttpRequest;s.open("GET","https://api.enthusiastgaming.net/scripts/cdn.enthusiast.gg/script/eg-aps/release/eg-aps-bootstrap-v2.0.0.bundle.js?site=nitrotype.com",!0),s.onreadystatechange=function(){var t;4==s.readyState&&(200<=s.status&&s.status<300||304==s.status)&&((t=e.createElement("script")).type="text/javascript",t.text=s.responseText,e.head.appendChild(t))},s.send(null)}(document);
                    (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
                            new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
                        j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
                        'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
                    })(window,document,'script','dataLayer','GTM-MCDJDHX');
                })();
            }
        </script>
    
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'9968ff194ea64f77',t:'MTc2MTgwNzIxNS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
